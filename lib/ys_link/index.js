  ...
  ysLinks.isInComponent = (link) => {
    const component = link.closest(
      [
        ...
        // The section dial, split out from the block dial in
        // YaleSites-Internal#1630. A themed section would still be caught by
        // `[data-component-width]` below, but relying on that would make this
        // check depend on an unrelated attribute staying on the section.
        '[data-section-theme]',
        '[data-menu-variation]',
