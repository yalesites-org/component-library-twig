...
Interactive.args = interactiveArgs;
...
const embedSoundCloudArgs = {
  width: 'site',
  type: 'audio',
  loading: 'lazy',
};

EmbedSoundCloud.args = embedSoundCloudArgs;
...
const embedPowerBIArgs = {
  width: 'site',
  type: 'form',
  loading: 'lazy',
};

EmbedPowerBI.args = embedPowerBIArgs;
...
const embedMicrosoftFormsArgs = {
  width: 'site',
  type: 'form',
  loading: 'lazy',
};

EmbedMicrosoftForms.args = embedMicrosoftFormsArgs;
...
const embedGoogleMapsArgs = {
  width: 'site',
  type: 'map',
  loading: 'lazy',
};

EmbedGoogleMaps.args = embedGoogleMapsArgs;
...
const embedGoogleCalendarArgs = {
  width: 'site',
  type: 'calendar',
  loading: 'lazy',
};

EmbedGoogleCalendar.args = embedGoogleCalendarArgs;
