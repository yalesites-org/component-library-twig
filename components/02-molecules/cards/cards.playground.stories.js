 ...
 */
export default {
  title: 'Molecules/Cards/Playground',
  parameters: {
    layout: 'fullscreen',
  },
  argTypes: {
      ...
      <div class='card-collection__inner'>
        <ul class='card-collection__cards'>
          ${referenceCardTwig({
            ...
            reference_card__heading: referenceCardData.reference_card__heading,
            reference_card__snippet: referenceCardData.reference_card__snippet,
      ...
      <div class='card-collection__inner'>
        <ul class='card-collection__cards'>
          ${referenceCardTwig({
            ...
            card_collection__type: 'grid',
            ...imageData.responsive_images['3x2'],
            reference_card__date: referencePageCardData.reference_card__date,
            reference_card__heading:
