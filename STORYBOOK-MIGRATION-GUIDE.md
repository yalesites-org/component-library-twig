...
- Comprehensive coverage for visual regression testing
...
### For QA
- **Comprehensive Coverage**: Visreg pages show every variation of a component
- **Visual Testing**: Compare a Storybook build against the previous one to spot regressions
